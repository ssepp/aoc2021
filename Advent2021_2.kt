package advent2021_2

import adventExtensions.extractInts

const val full_input = """forward 6
forward 9
down 9
down 7
forward 8
...
forward 5
"""
const val test_input = """forward 5
down 5
forward 8
up 3
down 8
...
fun main() {
    ...
    for (line in input.lines()) {
        ...
        if (line.startsWith("forward")) {
            pos += line.extractInts()[0]
            depth += aim* line.extractInts()[0]
        }

        if (line.startsWith("down"))
            aim += line.extractInts()[0]
